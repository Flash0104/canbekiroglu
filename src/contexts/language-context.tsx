...
const translations = {
  en: {
    ...
    "appointment.description": "Schedule a paid consultation to discuss your project ideas and technical requirements. Choose your preferred date, time, and service type.",
    "appointment.form.title": "Schedule Your Meeting",
    "appointment.form.description": "Fill out the form below and I'll get back to you within 24 hours to confirm your appointment.",
    ...
    "appointment.form.service": "Service Type",
    "appointment.form.message": "Additional Details",
    "appointment.form.send": "Book Appointment",
    "appointment.form.sending": "Booking...",
    "appointment.form.success": "Appointment request sent successfully! I'll contact you soon to confirm.",
    "appointment.form.error": "Failed to send appointment request. Please try again or contact me directly.",
    "appointment.form.namePlaceholder": "Your full name",
    "appointment.form.emailPlaceholder": "your.email@example.com",
    "appointment.form.phonePlaceholder": "+49 123 456 7890",
    "appointment.form.messagePlaceholder": "Tell me about your project, timeline, and any specific requirements...",
    "appointment.form.selectService": "Select a service",
    "appointment.service.softwaredevelopment": "Software Development Consultancy",
    "appointment.service.internationalstudy": "International Study Consultancy",
    "appointment.service.businesshelper": "Business Helper App Consultancy",
    "appointment.availability.title": "Availability",
    "appointment.availability.weekdays": "Monday - Friday",
    "appointment.availability.weekdaysHours": "9:00 AM - 6:00 PM (CET)",
    "appointment.availability.weekends": "Saturday - Sunday",
    "appointment.availability.weekendsHours": "10:00 AM - 4:00 PM (CET)",
    "appointment.availability.note": "All meetings can be conducted online via Google Meet, Zoom, or in-person if you're in the Duisburg area.",
    "appointment.contact.title": "Contact Information",
    "appointment.contact.email": "Email",
    "appointment.contact.location": "Location",
    "appointment.contact.timezone": "Timezone",
    "appointment.services.title": "Services Offered",
    "appointment.services.softwaredevelopmentDesc": "Expert consultation on software architecture, technology stack selection, development strategies, and project planning for your software projects.",
    "appointment.services.internationalstudyDesc": "Comprehensive guidance for international students pursuing education abroad, including university selection, application processes, and study planning.",
    "appointment.services.businesshelperDesc": "Strategic consultation for developing business applications, workflow optimization, and digital transformation solutions for your business needs.",
  ...
  de: {
    ...
    "appointment.description": "Buchen Sie eine kostenpflichtige Beratung, um Ihre Projektideen und technischen Anforderungen zu besprechen. Wählen Sie Ihr bevorzugtes Datum, Uhrzeit und Service-Typ.",
    "appointment.form.title": "Ihr Meeting planen",
    "appointment.form.description": "Füllen Sie das Formular unten aus und ich melde mich innerhalb von 24 Stunden bei Ihnen, um Ihren Termin zu bestätigen.",
    "appointment.form.name": "Vollständiger Name",
    "appointment.form.email": "E-Mail-Adresse",
    "appointment.form.phone": "Telefonnummer",
    "appointment.form.date": "Bevorzugtes Datum",
    "appointment.form.time": "Bevorzugte Uhrzeit",
    "appointment.form.service": "Service-Typ",
    "appointment.form.message": "Zusätzliche Details",
    "appointment.form.send": "Termin buchen",
    "appointment.form.sending": "Wird gebucht...",
    "appointment.form.success": "Terminanfrage erfolgreich gesendet! Ich werde Sie bald kontaktieren, um zu bestätigen.",
    "appointment.form.error": "Fehler beim Senden der Terminanfrage. Bitte versuchen Sie es erneut oder kontaktieren Sie mich direkt.",
    "appointment.form.namePlaceholder": "Ihr vollständiger Name",
    "appointment.form.emailPlaceholder": "ihre.email@beispiel.com",
    "appointment.form.phonePlaceholder": "+49 123 456 7890",
    "appointment.form.messagePlaceholder": "Erzählen Sie mir von Ihrem Projekt, Zeitplan und spezifischen Anforderungen...",
    "appointment.form.selectService": "Service auswählen",
    "appointment.service.softwaredevelopment": "Software-Entwicklungsberatung",
    "appointment.service.internationalstudy": "Internationale Studienberatung",
    "appointment.service.businesshelper": "Business-Helper-App-Beratung",
    "appointment.availability.title": "Verfügbarkeit",
    "appointment.availability.weekdays": "Montag - Freitag",
    "appointment.availability.weekdaysHours": "9:00 - 18:00 Uhr (CET)",
    "appointment.availability.weekends": "Samstag - Sonntag",
    "appointment.availability.weekendsHours": "10:00 - 16:00 Uhr (CET)",
    "appointment.availability.note": "Alle Meetings können online über Google Meet, Zoom oder persönlich durchgeführt werden, wenn Sie in der Nähe von Duisburg sind.",
    "appointment.contact.title": "Kontaktinformationen",
    "appointment.contact.email": "E-Mail",
    "appointment.contact.location": "Standort",
    "appointment.contact.timezone": "Zeitzone",
    "appointment.services.title": "Angebotene Services",
    "appointment.services.softwaredevelopmentDesc": "Expertenberatung zu Software-Architektur, Technologie-Stack-Auswahl, Entwicklungsstrategien und Projektplanung für Ihre Software-Projekte.",
    "appointment.services.internationalstudyDesc": "Umfassende Beratung für internationale Studierende, die im Ausland studieren möchten, einschließlich Universitätsauswahl, Bewerbungsverfahren und Studienplanung.",
    "appointment.services.businesshelperDesc": "Strategische Beratung für die Entwicklung von Geschäftsanwendungen, Workflow-Optimierung und digitale Transformationslösungen für Ihre Geschäftsanforderungen.",
  ...
  tr: {
    ...
    "appointment.description": "Proje fikirlerinizi ve teknik gereksinimlerinizi görüşmek için ücretli bir danışmanlık rezervasyonu yapın. Tercih ettiğiniz tarih, saat ve hizmet türünü seçin.",
    "appointment.form.title": "Toplantınızı Planlayın",
    "appointment.form.description": "Aşağıdaki formu doldurun, randevunuzu onaylamak için 24 saat içinde size geri döneceğim.",
    "appointment.form.name": "Ad Soyad",
    "appointment.form.email": "E-posta Adresi",
    "appointment.form.phone": "Telefon Numarası",
    "appointment.form.date": "Tercih Edilen Tarih",
    "appointment.form.time": "Tercih Edilen Saat",
    "appointment.form.service": "Hizmet Türü",
    "appointment.form.message": "Ek Detaylar",
    "appointment.form.send": "Randevu Al",
    "appointment.form.sending": "Rezerve Ediliyor...",
    "appointment.form.success": "Randevu talebi başarıyla gönderildi! Onaylamak için yakında sizinle iletişime geçeceğim.",
    "appointment.form.error": "Randevu talebi gönderilemedi. Lütfen tekrar deneyin veya doğrudan benimle iletişime geçin.",
    "appointment.form.namePlaceholder": "Adınız ve soyadınız",
    "appointment.form.emailPlaceholder": "email@ornek.com",
    "appointment.form.phonePlaceholder": "+90 123 456 7890",
    "appointment.form.messagePlaceholder": "Projenizden, zaman çizelgenizden ve özel gereksinimlerinizden bahsedin...",
    "appointment.form.selectService": "Bir hizmet seçin",
    "appointment.service.softwaredevelopment": "Yazılım Geliştirme Danışmanlığı",
    "appointment.service.internationalstudy": "Uluslararası Eğitim Danışmanlığı",
    "appointment.service.businesshelper": "İş Yardımcısı Uygulama Danışmanlığı",
    "appointment.availability.title": "Müsaitlik",
    "appointment.availability.weekdays": "Pazartesi - Cuma",
    "appointment.availability.weekdaysHours": "09:00 - 18:00 (CET)",
    "appointment.availability.weekends": "Cumartesi - Pazar",
    "appointment.availability.weekendsHours": "10:00 - 16:00 (CET)",
    "appointment.availability.note": "Tüm toplantılar Google Meet, Zoom aracılığıyla online veya Duisburg bölgesindeyseniz yüz yüze yapılabilir.",
    "appointment.contact.title": "İletişim Bilgileri",
    "appointment.contact.email": "E-posta",
    "appointment.contact.location": "Konum",
    "appointment.contact.timezone": "Saat Dilimi",
    "appointment.services.title": "Sunulan Hizmetler",
    "appointment.services.softwaredevelopmentDesc": "Yazılım projeleriniz için yazılım mimarisi, teknoloji yığını seçimi, geliştirme stratejileri ve proje planlaması konularında uzman danışmanlık.",
    "appointment.services.internationalstudyDesc": "Yurtdışında eğitim almak isteyen uluslararası öğrenciler için üniversite seçimi, başvuru süreçleri ve eğitim planlaması dahil kapsamlı rehberlik.",
    "appointment.services.businesshelperDesc": "İş uygulamaları geliştirme, iş akışı optimizasyonu ve işletme ihtiyaçlarınız için dijital dönüşüm çözümleri konularında stratejik danışmanlık.",
